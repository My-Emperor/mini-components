...
export default {
  ...
  methods: {
    ...
    initAudio() {
      ...
      this.innerAudioContext.volume = 0.4;
    ...
    getLyricList() {
      ...
      this.lyricList = [...emptySeat,...v,...emptySeat];
    ...
    //计算滚动到指定位置
    toScrollTop(){
      this.scrollTop = this.activeIndex * this.lyricItemHeight - (this.lyricItemHeight * 5)
...
/*  width: 100%;*/
/*  height: 6%;*/
/*  background-image:  linear-gradient(#fff 30% , rgba(255,255,255,0) 100%);*/
/*  z-index: 10;*/
/*}*/
/*.mini-lyrics-box::after{*/
/*  display: block;*/
/*  content:" ";*/
/*  position: absolute;*/
/*  bottom: 0;*/
